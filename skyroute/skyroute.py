...
landmark_string = ''
stations_under_construction = ['Lansdowne', 'B.C. Place Stadium']
...
def get_active_stations():
  ...
  for under_construction in stations_under_construction:
     for current_station, neighboring_stations in vc_metro.items():
       if current_station != under_construction:
...
def goodbye():
    return "Thanks for using SkyRoute!"
